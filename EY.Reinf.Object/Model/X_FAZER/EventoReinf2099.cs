...
{
    public abstract class EventoReinf2099
    {
        ...
        protected virtual XmlNode evento()
        {
            ...
            e.AppendChild(ideRespInf());
            e.AppendChild(infoFech());
        ...
        protected abstract XmlNode ideRespInf();
        protected abstract XmlNode infoFech();
